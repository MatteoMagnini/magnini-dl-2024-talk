...
\begin{frame}[c]{Experiments}
    ...
    %
    \begin{itemize}
        \item \emph{5 \EL~ontologies} $\rightarrow$ Animals, Cell, Football, Generation and University (from the ExactLearner work~\ccite{exact-learner-tool-2018}).
        %
        \vfill
...
\begin{frame}[c]{Future work}
    ...
    \vfill
    We are currently working on an extension of the ExactLearner~\ccite{exact-learner-tool-2018} framework to use LLMs as teachers.
    %
    Some spoilers:
    \vfill
    \begin{itemize}
